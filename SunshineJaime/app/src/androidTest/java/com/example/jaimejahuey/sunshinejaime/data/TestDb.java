...
/**
 * Created by jaimejahuey on 6/15/16.
 */
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        database.insert(WeatherContract.LocationEntry.TABLE_NAME, null, testValues);

        // Query the database and receive a Cursor back
        Cursor c = database.rawQuery("SELECT * FROM " + WeatherContract.LocationEntry.TABLE_NAME
                + " WHERE city_name='North Pole'", null);

        //How they queried the table
...
//        );
        ...
        assertTrue("Error testLocationTable: This means that we were unable to query the database for table information.",
                c.moveToFirst());
    ...
    public void testWeatherTable() {
        ...
        // Validate com.example.jaimejahuey.sunshinejaime.data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
